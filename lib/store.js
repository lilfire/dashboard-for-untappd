...
(function (root) {
  ...
  root.DFU.store = { ...pure, load, save, loadHistory, saveHistory, loadFriends, saveFriends, loadCountries, saveCountries, getSettings, setSettings, lastUser, clearAll, DEFAULT_SETTINGS };
